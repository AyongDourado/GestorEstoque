...
namespace GestorEstoque.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ProdutosController(GestorEstoqueContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Nome,ValorString,Validade")] Produto produto)
        {
            ...
            {
                produto.Valor = decimal.Parse(produto.ValorString);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GestorEstoqueContext.Produto'  is null.");
            }
            var produto = await _context.Produto.FindAsync(id);
            if (produto != null)
            {
